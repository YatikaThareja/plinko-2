...
function draw() {
  ...
  if (frameCount % 90 === 0){
    particles.push(new Particles(random(10,650),0,10))
  }
  ...
  if (particle!=null){
    particle.display();
      ...
      } else if(particle.body.position.y>600 && particle.body.position.x<301 ){
          score=score+100;
          particle=null;
          if (turn>=5){
         gameState="END"}
        }else if(particle.body.position.y>900 && particle.body.position.x<601 ){
          score=score+200;
          particle=null;
          if (turn>=5){
         gameState="END"}
